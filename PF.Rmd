...
```
###Modelos de primer orden para personas  que gastan más de 0 en educación
```{r}
modelo_1.1 <- lm(Education_Expenditure ~ Household_Head_Age, dbfsin0 = dbfsin0 )
modelo_1.2 <- lm(Education_Expenditure ~ Total_members_employed, dbfsin0 = dbfsin0)
